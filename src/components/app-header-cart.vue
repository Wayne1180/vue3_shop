<template>
  <div class="cart" @mousemove="change(true)" @mouseleave="change(false)">
    <!-- 购物车图标 -->
    ...
    >
      <div class="list">
        <div
          ...
          :key="goods.skuId"
        >
          <RouterLink :to="`/product/${goods.id}`" @click="change(false)">
